locals {
  lb_nat_rules = {
    ...
    "br2_fgt2_ssh"   = { name = "br2_fgt2_ssh", loadbalancer_id = "lb_branch2_ext_01", protocol = "Tcp", frontend_port = "2422", backend_port = "3422", frontend_ip_configuration_name = "pip_br2_elb_01" }
  }
}
